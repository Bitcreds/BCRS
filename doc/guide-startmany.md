...
2. [Sending 500 BCRS to new wallet addresses.](#option2)
...
### Send 500 BCRS to New Addresses

Just like setting up a standard SN. Send exactly 500 BCRS to each new address created above.
...
Copy the Masternode private key and correspondig collateral output transaction that holds the 1K BITCREDS.

The Masternode private key may be an existing key from [Option 1](#option1), or a newly generated key from [Option 2](#option2). 

*Please note, the Masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 500 BCRS on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the bitcreds github repo](https://github.com/bitcreds-crds/bitcreds/blob/master/doc/masternode_conf.md)
...
## What about the bitcreds.conf file?

If you are using a masternode.conf file you no longer need the bitcreds.conf file. The exception is if you need custom settings (thanks oblox). 
...
```sudo nano .bitcreds/bitcreds.conf```
...
And compare with the official explorer at http://explorer.bitcredspay.io/chain/Bitcreds
