...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcredsURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BitcredsUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcredsURI(info));
}
