    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BITCREDS-light"), QVariant("light"));
    ...
    ui->unit->setModel(new BitcredsUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcredsAtStartup, OptionsModel::StartAtStartup);
