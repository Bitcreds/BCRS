...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBitcredsAddress demoAddress;
    UniValue retValue;
    std::string strAccount = "walletDemoAccount";
    CBitcredsAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CBitcredsAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBitcredsAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     *          setaccount
     *********************************/
    ...
    BOOST_CHECK(CBitcredsAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcredsAddress(arr[0].get_str()).Get() == demoAddress.Get());
