...
class TxnMallTest(BitcredsTestFramework):
    ...
    def run_test(self):
        ...
        # Node0's balance should be starting balance, plus 500 BCRS for another
        ...
        # Node0's total balance should be starting balance, plus 1000 BCRS for
